...
namespace AdventureTime
{
    public partial class Schedule : Form
    {
        ...
        private void Schedule_Load(object sender, EventArgs e)
        {
            ...
            this.schedulefullTableAdapter.Fill(this.advTimeDataSet1.Schedulefull);
            ...
            this.scheduleTableAdapter.Fill(this.advTimeDataSet.Schedule);
        ...
        private void newschedulebutton_Click(object sender, EventArgs e)
        {
            ...
            this.schedulefullTableAdapter.Fill(this.advTimeDataSet.Schedulefull);
